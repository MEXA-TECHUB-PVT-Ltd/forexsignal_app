...
import {brown, greyBold, greyExtra, orange, textBlack, textGrey, white} from '../assets/Colors';
...
<TouchableOpacity style={{flexDirection:'row', marginBottom:wp(5), marginHorizontal:wp(8), marginTop:hp(5), alignItems:'center', justifyContent:'center', backgroundColor:orange, borderRadius:wp(5), height:hp(6)}}>
