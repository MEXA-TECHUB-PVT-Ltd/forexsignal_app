...
import CheckSnackBar from '../assets/svg/CheckSnackBar'
...
const CustomSnackbarAlert = ({visible, message, messageDescription, onDismiss}) => {
  ...
  return (
    <Animated.View
      ...
      <CheckSnackBar width={50} height={50}/>
      </View>
